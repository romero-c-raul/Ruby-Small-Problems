...
def string_to_signed_integer(string)
  leading_character = string[0]
  no_leading_char_string = string.delete(leading_character)

  case leading_character
  when "-"
    string_to_integer(no_leading_char_string) * -1
  when "+"
    string_to_integer(no_leading_char_string)
  else
